...
public class RedisTests {
    ...
    public void testHashes() {
        ...
        redisTemplate.opsForHash().put(redisKey, "username", "zhangfei");
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey, "张飞", "刘备", "关羽");
    ...
    public void testSortedSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "悟空", 50);
